...
output_video = cv2.VideoWriter('output.mp4', fourcc, 25.07, (1280, 720))

# Load some sample pictures and learn how to recognize them.
female_image = face_recognition.load_image_file("images/sabyan.jpg")
female_face_encoding = face_recognition.face_encodings(female_image)[0]

male_image = face_recognition.load_image_file("images/botak.jpg")
